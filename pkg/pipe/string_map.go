...
func (p StringMapPipe) Store(store store.StoreStringMap, errH e.HandleError) (np StringMapPipe) {
...
func (p StringMapPipe) Stream(store store.StreamStringMap, errH e.HandleError) (np StringMapPipe) {
